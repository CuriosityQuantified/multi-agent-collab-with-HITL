...
# Set up checkpointer and compile
...
config = {
    "configurable": {
        "thread_id": thread_id,
        "checkpoint_ns": ""  # Optional
    }
}

for output in app.stream(initial_state, config=config):
    if "messages" in output and output["messages"] and output["current_agent"] not in [END, "human"]:
        print(f"\n--- {output['current_agent'].upper()} ---")
